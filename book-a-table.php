...
?>
  ...
  <section class="u-displayTable [ top-section-wrapper ]">
    ...
    <div class="top-section top-section--skin top-section--bkg top-section--bkg-findUs u-cf [ amberBorder ]" style="background-image: url('<?php echo get_bloginfo('template_directory');?>/images/book-a-table/book-a-table-illustration.png');">
      ...
      <p>
        ...
        or email us: <a class="u-textBreak" href="mailto:reservations@newmanstreettavern.co.uk?subject=48 Newman Street Reservation Enquiry">reservations@48newmanstreet.co.uk</a>
      </p>
