...
?>
  ...
  <div class="hero-container u-cl">
    ...
    <div class="slider-aside u-cl [ amberBorder ]">
      <h2 class="u-margin-t-flush u-textUpperCase [ slider-aside__title ]">Welcome to <span class="u-inlineBlock">48 Newman Street tavern</span></h2>
      <div class="slider-aside__child"><img src="<?php echo get_bloginfo('template_directory');?>/images/slider-aside-img.gif" style="max-height:220px" alt="Illustration"></div>
      <div class="slider-aside__child">
        ...
        <p class="contact-details-address [ u-margin-t-flush u-textCapitalize ]">
          <a href="https://www.google.com/maps/d/viewer?mid=zn1D3o-JjyLA.konmZEl969Bg&msa=0&ll=51.518978,-0.136954&spn=0.006222,0.016512" target="_blank" alt="View on Google Maps">
  ...
  <div class="[ grid-element ] magicBox lastBlogPostBox">
    <div class="magicBox-overlay magicBox--light lastBlogPost center-parent [ amberBorder ]">
