...
?>
  ...
  <section class="u-displayTable [ top-section-wrapper ]">
    ...
    <div class="top-section top-section--skin top-section--bkg [ amberBorder ]">
      <h2 class="u-margin-t-flush  [ page-title ]"><?php echo get_the_title(); ?></h2>
      <?php echo $menus_top_section_copy; ?>

      <a href="mailto:reservations@48newmanstreet.co.uk?subject=48 Newman Street Private Dining Enquiry" class="btn btn--topSection borderDouble button-dark">Email us</a>
  ...
  <!-- Rect1 -->
  <div class="[ grid-element--rect magicBox--rectCopy1 ] magicBox magicBox--light [ amberBorder ]">
    <div class="rect-copy-wrapper u-cf">
      ...
      <p class="column column-right">
        <strong>Semi-private dining room:</strong> <?php echo $private_dining_capacity_spec1; ?> <br>
        <strong>Upstairs dining room:</strong> <?php echo $private_dining_capacity_spec2; ?> <br>
        <strong>Entire venue:</strong> <?php echo $private_dining_capacity_spec3; ?>
      </p>
